...
BeatovnikWidget::BeatovnikWidget() {
	...
	addParam(createParam<RoundBlackKnob>(Vec(6, 73),	module, Beatovnik::TIME_PARAM,	-0.3, 5.3, 2));
	...
	for (int i = 0; i < 6; i++) {
		addChild(createLight<SmallLight<RedLight>>(Vec(12+i*12, 53), module, Beatovnik::NOTE_LIGHT + i));
	}
